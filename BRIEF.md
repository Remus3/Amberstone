...
- **Numbers:** 2,283 passing tests on the DPS engine; 547/547 DDragon purchasable items covered; coaching response latency ~1-2s (Haiku); DPS engine answers in <10ms locally; 8+ months of daily iteration across ~100 tracked sessions
...
### Resume bullet
Built a real-time League of Legends AI coaching system - local DPS engine covering 547 items + Claude Haiku integration - reducing item-decision latency from "pause and look it up" to <2s with 2,283 passing tests.
