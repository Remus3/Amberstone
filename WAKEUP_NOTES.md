...
3 live bugs found (this session, 2 FIXED, 1 later):
1. Enemy spells panel overflow -- 5 enemies x 2 spells = 10 chips at y:120, CSS overflow -- FIXED fb08ea23 (widened w-enemyspells --ovx-w 210->280px)
2. "Buy Gunmetal Greaves" stale coach tip -- DS rank clean, but static build_order_sr.json has stale T3 boots from pre-fix regen (G2 prereq: regen HZ build-order tables) -- FIXED 268e0952 + 19a76d8b/415c1795
3. map_control was 5x duped -- FIXED 2ddbc331

NEXT SESSION: pick from (a) Section J OPEN WPs, (b) DS engine gaps (Aphelios rotation-DPS/A), (c) continue drain with REAL-SR or ARAM-MAYHEM queue for remaining live-gated items.
