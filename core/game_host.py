...
Legion itself, so the default is 127.0.0.1. In the legacy 2-PC topology this
was the Game-PC LAN IP (192.168.8.237). Set the RC_GAME_HOST env var to
override if the game ever runs on a different host.
"""
import os
