...
5b. 🟠 Phase 3 — Frontend ESM in progress (s132, 7bbf032): lib/ extraction done (helpers/state/items_index/idempotent_render + main.js). Next: extract panels into `web/js/panels/*.js`.
