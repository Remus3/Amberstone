...
> **Deep references:** `docs/DAEMON_SLAYER.md` (DS engine · 547 items · ENGINE_VERSION 1.6.0 · all 6 archetype scorers wired) · `docs/AGENTS.md` (Phase 3 framework) · `BACKLOG.md` (aspirational)
