...
Usage:
  py scripts/retrofill_match_metrics.py               # all matches (resumable)
  py scripts/retrofill_match_metrics.py --limit 50    # first 50 unprocessed
  py scripts/retrofill_match_metrics.py --match NA1_5182398158   # one match
"""
