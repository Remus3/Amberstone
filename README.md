...
| Daemon Slayer DPS engine | ✅ 547 items, 1257 tests, ENGINE 0.67.0; `:8893` service; all 4 coaches wired (DS-before-Haiku); dead-unique filter live; 4 of 6 archetype scorers fully wired through `rank_for_primary_archetype()` (carry/bruiser/tank/mage); Tank EHP s174 + Bruiser hybrid s175 + CS picker s176 + Phase 4a ingest s177 + Phase 4b evaluator s178 + Phase 4c ranker s179 (`/rank-mage` + dispatcher) — assassin/enchanter still fall back to ds.dps pending Phases 5-6 |
