...
> 2. **New session:** re-probe live state, THEN act. Verify before building.
...
> 4. Trivial one-line cosmetic edits may inline (refines R9). See `CLAUDE.md` "Subagent-First Protocol".
