...
REM Resolve cert path. We try, in order:
REM   1. Same directory as this script (Legion just pushed both to RCClient).
REM   2. \\192.168.8.230\RCClient\rc-mkcert-rootCA.pem (Legion share back-fetch).
REM   3. C:\RC-Agent\rc-mkcert-rootCA.pem (local copy).
set CERT=
for %%P in (
    "%~dp0rc-mkcert-rootCA.pem"
    "\\192.168.8.230\RCClient\rc-mkcert-rootCA.pem"
...
if "%CERT%"=="" (
    ...
    echo         on \\192.168.8.230\RCClient\, or at C:\RC-Agent\.
