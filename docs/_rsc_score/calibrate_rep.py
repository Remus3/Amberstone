...
Run (from the repo root):
  py docs/_rsc_score/calibrate_rep.py blind --out <path>
  py docs/_rsc_score/calibrate_rep.py check --blinded <path>
  py docs/_rsc_score/calibrate_rep.py tally --scorers <A.md> <B.md> <C.md>
"""
