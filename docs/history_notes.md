...
# 2026-05-19 - CLAUDE.md Active-priorities ledger archived (items 1-93, verbatim relocation, zero rewrite)

Relocated out of CLAUDE.md to cut ~230 KB off every-turn context (operator-approved 2026-05-19; "keep history" honored via verbatim archive-not-delete - nothing rewritten or summarized). Numbering and prose below are exactly as they stood in the CLAUDE.md ledger. A compact "Settled - do not re-litigate" digest stays inline in CLAUDE.md; this is the full detail it points at.
