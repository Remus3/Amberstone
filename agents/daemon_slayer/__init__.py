...
Black Cleaver), and 23 defensive_only items spanning the Tier-1 SR /
Arena pool plus high-pickrate batch 2 additions (Death's Dance,
Spear of Shojin, Essence Reaver, Heartsteel, Warmog's, Mercurial
Scimitar, Guardian Angel, Banshee's Veil, Zhonya's, Stridebreaker).
CallContext + callable ``bonus_damage`` lets stat-scaling procs
bind to ``base_ad`` / ``bonus_ad`` / ``level``.
