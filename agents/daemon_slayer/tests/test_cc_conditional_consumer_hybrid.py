"""ENGINE 1.39.0 (2026-05-22) - compute_hybrid consumer wire for cc_conditional.
...
authorized consumer. ENGINE 1.39.0 (item 143 Slice B) wires
...
class EngineVersionCurrentTests(unittest.TestCase):
    """Pin ENGINE_VERSION (orchestrator syncs to 1.39.0 at merge)."""
    ...
    def test_engine_version_is_current(self) -> None:
        ...
        # bumps to 1.39.0 post-merge of Slice A + Slice B.
