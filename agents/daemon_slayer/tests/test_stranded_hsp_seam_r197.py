...
STRANDED_TODAY: dict[str, str] = {
    ...
    # ENGINE 1.273.0 and is therefore gone from this ledger. The "own slice, not
    ...
    # /hybrid and /rank-bruiser at the same ENGINE 1.273.0 and are likewise
    # gone.)
    # (The R212 crit CHANCE / crit DAMAGE MULTIPLIER lane -
    # apply_crit_chance_overrides - was wired to /dps at ENGINE 1.273.0. Its
