...
_ALLOWED_TEST_FILES = {
    ...
    "test_cc_conditional_wave10.py",
    "test_cc_conditional_wave11.py",
    "test_cc_conditional_wave12.py",
    "test_cc_conditional_wave13.py",
    ...
    "test_cc_conditional_consumer_parity.py",
