...
engine. The fix is a deterministic, engine-less regen (no :8893 required):
    ...
    C:/Users/Administrator/AppData/Local/Programs/Python/Python314/python.exe -m core.build_order_precompute --static --mode all
    C:/Users/Administrator/AppData/Local/Programs/Python/Python314/python.exe -m core.build_order_variants   --static --mode all
...
def test_build_order_precompute_stamp_tracks_engine(mode: str) -> None:
    ...
    assert payload, (
        ...
        f"regen: C:/Users/Administrator/AppData/Local/Programs/Python/Python314/python.exe -m core.build_order_precompute --static --mode all"
    )
...
def test_build_order_variants_stamp_tracks_engine(mode: str) -> None:
    ...
    assert payload, (
        ...
        f"{patch}; regen: C:/Users/Administrator/AppData/Local/Programs/Python/Python314/python.exe -m core.build_order_variants --static --mode all"
    )
    assert payload.get("engine_version") == ENGINE_VERSION, (
        f"HZ-B2 build_order_variants_{mode}.json stamped "
        f"{payload.get('engine_version')!r}, engine is {ENGINE_VERSION!r}; "
        f"regen: C:/Users/Administrator/AppData/Local/Programs/Python/Python314/python.exe -m core.build_order_variants --static --mode all"
    )
