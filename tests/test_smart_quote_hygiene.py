...
If this test fails on a freshly added file, run:
    py tools/strip_smart_quotes.py            # dry-run report
    py tools/strip_smart_quotes.py --apply    # rewrite in place
...
def test_no_smart_quotes_in_authored_source() -> None:
    ...
    if violations:
        ...
        msg = (
            ...
            "Run `py tools/strip_smart_quotes.py` to inspect, then `--apply` "
