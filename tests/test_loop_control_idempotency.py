...
def test_queue_intent_records_the_fixed_next_session_path(ctldir):
    ...
    # Single well-known path, OVERWRITE-on-write, no timestamp suffix.
    assert doc["next_session_path"] == "Desktop/NEXT-SESSION.txt"
    assert mod.NEXT_SESSION_PATH == "Desktop/NEXT-SESSION.txt"
